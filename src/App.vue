<template>
  <main>
    <div class="h-screen pt-10 bg-gradient-to-b from-cyan-500 to-violet-500">			
        ...
        <div class="flex flex-col items-center mt-5">					
          <div class="text-2xl mb-4"> 
            <div class="h-full bg-white p-4 bg-gradient-to-b from-cyan-500 to-violet-500 rounded-full">
              <div class="px-6 py-2 bg-slate-200 rounded-full font-bold text-center">
          ...
          <div class="mt-2 font-semibold flex"> 
            ...
            <p class="text-2xl">
              ...
              <span class="text-[12px] align-super">(dernière maj: {{ weather.current.last_updated.slice(10) }})</span>
            </p>
          </div>
          <p class="mb-4 ">
            <span class="font-semibold">ressenti:</span>  {{ weather.current.feelslike_c }}°c
          </p>
          <div class="text-xl">
            Temps actuel: <span class="font-semibold">{{ weather.current.condition.text }}. </span> 
          </div>
